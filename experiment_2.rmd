...
all_results |> 
  readr::write_csv(file = here::here("data", "experiment_2_all_results.csv"))
```
...
readr::write_csv(cycles, file = here::here("data", "experiment_2_cycles.csv"))
```
...
cycles <- readr::read_csv(file = here::here("data", "experiment_2_cycles.csv"),
